...
if chart_type == "3D Scatter Plot":
    ...
    st.markdown("This 3D scatter plot provides a visual representation of COVID-19 cases in Tunisia throughout the year 2020.")
    st.markdown("The color of data points represents the number of cases, with a green-to-red scale.")
    st.markdown("You can adjust the filter threshold to focus on cases above a certain level.")
    st.markdown("Explore the interactive features to gain insights from the data.")
    st.markdown("We can see that the daily cases up until month 8 were constant, but they started increasing and varying. This has to do with the gradual lift of lockdown that happened around May in Tunisia.")
