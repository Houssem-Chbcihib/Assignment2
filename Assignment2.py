...
page = st.sidebar.selectbox("Select Page", ["Data Visualization", "Show Data"])
...
if page == "Data Visualization":
    ...
    chart_type = st.selectbox("Select Chart Type", ["3D Scatter Plot", "Line Chart"])
    ...
    if chart_type == "3D Scatter Plot":
        ...
        st.markdown("This 3D scatter plot displays the distribution of COVID-19 cases in Tunisia in 2020. The three axes represent Month (indicating the number of corresponding month), Day (indicating the day of the month), and Cases (the number of recorded cases). You can manipulate the graph by choosing data to observe using the filter above. For example, if you choose a value of 4000, the graph will only plot data points with corresponding cases equal to or higher than 4000.", unsafe_allow_html=True)
